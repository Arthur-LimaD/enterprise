...
function Presentation () {
    ...
    <section className={styles.contact} id="contact">
            ...
            <div className={styles.contact_right}>
                <ul>
                <li>Email: aisfhaisnmdf@gmail.com</li><div><span class="material-symbols-outlined">mail</span></div>
                <li>Telefone: 55 3581216946</li> <div><span class="material-symbols-outlined">phone_in_talk</span></div>
